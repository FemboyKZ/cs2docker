...
for (( first=1;; first=0 )); do
    ...
    layers_ok=1
    for layer_name in mm accel kz mam sql_mm ccvar cleaner listfix beamfix spamfix banfix wscleaner fkzapi cs2admin cs2menus cs2whitelist cs2rockthevote autorestart; do
