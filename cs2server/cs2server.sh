...
for (( first=1;; first=0 )); do
    ...
    layers_ok=1
    for layer_name in mm accel kz cssharp mam sql_mm ccvar cleaner listfix banfix wscleaner cs2kzstatus cs2admin cs2whitelist cs2rockthevote autorestart; do
